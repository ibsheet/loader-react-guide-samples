        ...
        <div className={ styles.infooter }>
          ...
          <div className={ styles.provide }>
            ...
            <ul>
              ...
              <li>
                <span className={ styles.spContent1 }>
                  <StyleLink underline='none' color='inherit' href='https://docs.ibsheet.com/ibsheet/v8/manual/#docs/intro/feature'>
                    IBSheet8 Manual
                  </StyleLink>
                </span>
                <span className={ styles.spContent2 }>
              ...
              <li>
                <span className={ styles.spContent1 }>
                  <StyleLink underline='none' color='inherit' href='https://demo.ibsheet.com/ibsheet/v8/samples/customer-sample/html/main.html'>
                    IBSheet8 Sample
                  </StyleLink>
                </span>
                <span className={ styles.spContent2 }>
